...
![geom_timeline output](geom_timeline output1.png)
...
![geom_timeline output](geom_timeline output2.png)
...
![geom_timeline_label output](geom_timeline_label output.png)
...
![Screenshot of interactive plot](eq_map output.png)
